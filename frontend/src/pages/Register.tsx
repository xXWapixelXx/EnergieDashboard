...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col justify-center items-center bg-gradient-to-br from-primary-900 via-purple-900 to-gray-900 relative overflow-hidden max-h-screen overflow-auto">
      <div
        style={{
      ...
      >
        <div ref={contentRef}>
          ...
          <div className="w-full max-w-xl sm:max-w-2xl mx-auto relative z-10 flex flex-col items-center px-4 sm:px-6 md:px-8">
            {/* Logo and Title */}
            <motion.div
            ...
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-4 sm:p-8 md:p-12 border border-white/20 w-full max-w-xl sm:max-w-2xl"
            >
              {error && (
                <motion.div
